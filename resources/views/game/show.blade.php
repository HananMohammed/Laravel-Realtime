                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img id="circle" class="" src="{{ asset('assets/images/circle.png') }}" height="250" width="250"  alt="circle" >
                            <p id="winner" class="display-1 d-none text-primary" ></p>
                        </div>
                        <hr />
                        <div class="text-center">
                            <label class="font-weight-bold h5"> Your Bet </label>
                            <select id="bet" class="custom-select col-auto form-control">
    ...
    <script>
        ...
        Echo.channel('game')
            .listen('RemainingTimeChanged', (e)=>{
                console.log('RemainingTimeChanged', e)
